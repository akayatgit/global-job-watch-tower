...
URL or forwarded clip
  ...
  → Telegram: reel → Save / Show prompt / Copy prompt / Twist (no prompt flood)
  → magic pencil: Gemini rewrites every beat · Nano Banana 2 Lite one-line edit on each still
  → Telegram: Show / Copy on the twisted prompt + twisted cut frames
```
