...
| **Remote browser access (2026-08-03)** | **Option B chosen:** Cloudflare Tunnel + Access. Brain stays on ThinkPad; `cloudflared` publishes HTTPS; Access email OTP = Ashok only. Not Vercel / not Supabase mirror. Guide: [`documents/remote-access-cloudflare.md`](remote-access-cloudflare.md); setup: `scripts/cloudflare_tunnel_setup.sh`. |
...
| v0.21 | 2026-08-03 | Akay | **Remote access Option B:** Cloudflare Tunnel + Access (sole-user HTTPS). `cloudflared` installed; setup script + `documents/remote-access-cloudflare.md`. Awaiting Ashok domain + Access email to go live. |
